...
>/etc/arca/counter
while true; do
        if [ $(curl -I -s -o /dev/null -w "%{http_code}" https://www.youtube.com) -eq 200 ] && [ $(curl -I -s -o /dev/null -w "%{http_code}" https://fast.com) -eq 200 ] && [ $(curl -I -s -o /dev/null -w "%{http_code}" https://telegram.org) -eq 200 ]; then
